...
const AboutPage = () => {
  return (
    <div className="about-page">
      ...
      {/* Vision Metrics */}
      <section className="vision-metrics py-5" style={{ marginTop: '-50px', position: 'relative', zIndex: 10 }}>
        <div className="container">
      ...
      {/* Policy & Mission */}
      <section className="policy-section py-5 bg-light">
        <div className="container">
      ...
      {/* Value Proposition for Two Pillars */}
      <section className="dual-value-section py-5">
        <div className="container">
          <div className="dual-grid">
            {/* Investor Value */}
            <div className="value-column investor-col">
              <div className="value-header">
                <h3>오너(투자자) 가이드</h3>
                <p className="catchphrase">"세무서로 가던 당신의 자본을<br/>우리 동네 맛집의 지분으로."</p>
            ...
            {/* Founder Value */}
            <div className="value-column founder-col">
              <div className="value-header">
                <h3>창업자 가이드</h3>
                <p className="catchphrase">"실력은 당신이, 자본은 오너스 코리아가.<br/>1,000만 원으로 여는 당신의 첫 매장."</p>
                <div className="purpose-box">
