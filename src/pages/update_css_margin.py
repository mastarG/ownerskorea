...
for i, line in enumerate(lines):
    if "/* Vertical Indicator v5 - Minimalist (Right Position) */" in line:
        start_idx = i
        break
...
if start_idx != -1:
    new_content = [
        "\n",
        "/* Vertical Indicator v5 - Minimalist (Right Position with Spacing) */\n",
        ".startup-indicator-v5 {\n",
        "  position: fixed;\n",
        "  right: 5rem; /* Increased Margin for better balance */\n",
        "  top: 50%;\n",
    ...
    with open(path, 'w') as f:
        f.writelines(lines)
    print("Successfully updated CSS Margin")
else:
