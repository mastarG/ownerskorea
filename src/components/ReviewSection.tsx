...
const testimonials = [
  {
    id: 1,
    quote: <>개원 후 세금 문제로 고민이 많았는데, 오너스코리아를 통해 <span className="highlight-text-gold">절세 효과와 안정적인 현금흐름</span>을 만들 수 있었습니다.</>,
    name: "김민호 원장",
    profession: "피부과 전문의",
  ...
  {
    id: 2,
    quote: <>주식이나 코인은 변동성이 커서 부담스러웠습니다. 오너스코리아는 <span className="highlight-text-gold">실제 매출이 발생하는 우량 매장에 투자하여 꾸준한 수익</span>을 주는 것이 장점입니다.</>,
    name: "이승준 변호사",
  ...
  {
    id: 3,
    quote: <>매일 실시간으로 점포 매출 데이터를 확인할 수 있어 투명합니다. <span className="highlight-text-gold">3천만 원 단위로 A급 상권에 분산 투자</span>할 수 있어 매우 만족스럽습니다.</>,
    name: "최수영 이사",
    profession: "IT 기업 임원",
  ...
  {
    id: 4,
    quote: <>단순히 이자만 받는 게 아니라 진짜 '가게 사장님'이 된 것 같은 재미가 있습니다. <span className="highlight-text-gold">매일매일의 현장 리포트를 읽는 것</span>도 쏠쏠한 즐거움입니다.</>,
    name: "박지훈 대표",
    profession: "스타트업 창업가",
  ...
  {
    id: 5,
    quote: <>세무 대리인으로서 고객들에게 적극 추천하는 모델입니다. <span className="highlight-text-gold">100% 소득공제와 50% 우선순위 상환권</span> 구조는 법적으로도 매우 안전합니다.</>,
    name: "정서윤 세무사",
    profession: "회계법인 파트너",
  ...
  {
    id: 6,
    quote: <>바쁜 스케줄 탓에 부동산 임장조차 가기 힘든데, <span className="highlight-text-gold">앱 하나로 프리미엄 매장의 주인이 되어 배당</span>을 받을 수 있다는 점이 매력적입니다.</>,
    name: "강태오 교수",
    profession: "대학병원 외과",
